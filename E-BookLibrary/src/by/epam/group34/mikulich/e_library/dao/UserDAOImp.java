...
public class UserDAOImp implements UserDAO{
    ...
    public void isBookDeleteFromUser(int userNumber, int userChoice) throws Exception{
       // NodeList booklist = document.getElementsByTagName("Book");
        ...
        public List<User> allUsersList() throws Exception {
        ...
        return usersList;
            ...
            public boolean addNewUserDAO(String newUserName,
                ...
                password.setTextContent(newUserPassword);
                // <firstName>
                Element firstName = document.createElement("firstName");
                firstName.setTextContent(newUserFirstName);
                // <lastName>
                Element lastName = document.createElement("lastName");
                lastName.setTextContent(newUserLastName);
                // <role>
                Element userRole = document.createElement("role");
                userRole.setTextContent(newUserRole.toString());
                // <lastName>
                Element listBook = document.createElement("listBook");
        ...
        public void deleteUserDAO(int userChoice) throws Exception{
            Node node = (Element)document.getElementsByTagName("User").item(userChoice);
