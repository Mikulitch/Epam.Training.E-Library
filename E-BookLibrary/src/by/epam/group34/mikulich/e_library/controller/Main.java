        ...
        while (menuChoice) {
            ...
            switch (userChoice) {
                ...
                case(6):
                    ...
                    userList = UserServiceImp.takeAllUsers();
                    int count=1;
                    for (int index = 0 ; index < userList.size();index++) {
                        System.out.println(count+index+"."+userList.get(index).toString());
                    }
                    System.out.println("Выберите номер пользователя для удаления");
                    userChoice = scan.nextInt();
                    while (true) {
                        if (userChoice<0 || userChoice>userList.size()) {
                            System.out.println("Введенное число некорректно. Повторите ввод.");
                        }
                        else break;
                    }
                    int result = UserServiceImp.deleteUser(userChoice);
                    if (result==1) {
                ...
                case(7):
                    ...
                    String newUserName, newUserPassword, newUserFirstName, newUserLastName;
                    List<Book> newUserListBook=new ArrayList<>();
                    // int id;
                    Roles newUserRole;
                    ...
                    newUserFirstName=scan.next();
                    System.out.println("Введите Фамилию пользователя:");
                    newUserLastName=scan.next();
                    ...
                    System.out.println("Введите жанр книги");
                    newUserRole=Roles.valueOf(scan.next().toUpperCase(Locale.ROOT));
                    //System.out.println(newBookGenre);
                    int addUserCheck =UserServiceImp.addNewUser(newUserName,newUserPassword,newUserFirstName,newUserLastName,newUserListBook,newUserRole);
                    if (addUserCheck ==1) {
